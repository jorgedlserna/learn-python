...
myDog = {'name': 'Luna', 'age': 3, 'weight': 35, 'breed': 'Standard Poodle'}

# Printing each key with its value in a sentence
print(myDog['name']+" is a "+myDog['breed']+". She is "+str(myDog['age'])+" years old and weighs "+str(myDog['weight'])+"lb.")

# By using the method "get" to the dictionary, you can call a key with a default value
print(myDog['name']+" is a "+myDog.get('color', 'white'),myDog['breed']+". She is "+str(myDog['age'])+" years old and weighs "+str(myDog['weight'])+"lb.")

# Adding the key "color" with value "brown"
myDog['color']='brown'

# The key "color" has the value "brown" instead of "white"
print(myDog['name']+" is a "+myDog.get('color', 'white'),myDog['breed']+". She is "+str(myDog['age'])+" years old and weighs "+str(myDog['weight'])+"lb.")
...
# Creating a loop that counts each character and how many times it appears
for character in message.lower():
    count.setdefault(character, 0)
    count[character]=count[character]+1

print("The Romeo and Juliet play has:")

# Sorting the dictionary and printing key with its value
for key, value in sorted(count.items()) :
    if key=="\n":
        print(value, " line breaks")
    elif key==" ":
        print(value,"spaces")
    else:
       print(value,key)
